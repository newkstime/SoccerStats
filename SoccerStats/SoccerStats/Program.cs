...
namespace SoccerStats
{
    class Program
    {
        ...
        //just a method to practice WebClient request
        ...
        //method to get news articles from Bing Web Search API
        public static List<NewsResult> GetNewsForPlayer(string playerName)
        {
            var results = new List<NewsResult>();
            var webClient = new WebClient();
            //API Key may go out of date!!
            webClient.Headers.Add("Ocp-Apim-Subscription-Key", "2e2197d3b23b467d81b3e47503e20cf3");
        ...
        //method to send the summary of news articles to Azure Text Analtics API Sentiment Analyzer and return a score
        public static SentimentResponse GetSentimentResponse(List<NewsResult> newsResults)
        {
            ...
            var webClient = new WebClient();
         // API Key may be out of date!!
            webClient.Headers.Add("Ocp-Apim-Subscription-Key", "07a8b06c0b094451aea30110819224ec");
